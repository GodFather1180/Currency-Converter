...
app_name = Label(top,image = icon, compound=LEFT, text = "currency converter", height=5, padx=22, pady=30, anchor=CENTER, font=('arial 16 bold'), bg=cor2, fg=cor0)
app_name.place(x=0, y=0)

#MAIN FRAME
result = Label(main, text = " ",width=16, height=2, pady=7, relief="solid", anchor=CENTER, font=('Ivy  16 bold'), bg=cor0, fg=cor1)
...
button = Button(main, text="convert", width=19, padx=5, height=1, bg=cor3, fg=cor0, font=("Ivy 12 bold"), command= convert)
